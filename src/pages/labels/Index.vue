<template>
    <div>
        <Header title='Labels'>
            <router-link to="/labels/create" v-if="!isBusy">Create</router-link>
        </Header>
                ...
                <q-markup-table>
                    ...
                    <tbody>
                        <tr v-for="row in rows" v-bind:key="row.id">
                            ...
                            <td class="text-left">
                                <ColourBadge v-bind:colour="row.colour" v-bind:label="row.colour" />    
                            </td>
                            <td class="text-left">
                                <LabelStatusBadge v-bind:value="row.status" />    
                            </td>
                            <td class="text-right">
                                <router-link v-bind:to="'/labels/' + row.id">View</router-link>    
                            </td>
                        </tr>
                    </tbody>
                </q-markup-table>
